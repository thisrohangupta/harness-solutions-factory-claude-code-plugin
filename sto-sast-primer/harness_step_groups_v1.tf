resource "harness_platform_template" "stg_Gitleaks_Scans_v1" {
  depends_on   = [time_sleep.step_groups_v2]
  ...
  template_yaml = templatefile(
    "${path.module}/templates/step_groups/v1/stg_Gitleaks_Scans.yaml",
    {
...
resource "harness_platform_template" "stg_OSV_SCA_v1" {
  depends_on   = [time_sleep.step_groups_v2]
  ...
  force_delete = true
  template_yaml = templatefile(
    "${path.module}/templates/step_groups/v1/stg_OSV_SCA.yaml",
    {
...
resource "harness_platform_template" "stg_OWASP_Dependency_Check_v1" {
  depends_on   = [time_sleep.step_groups_v2]
  ...
  force_delete = true
  template_yaml = templatefile(
    "${path.module}/templates/step_groups/v1/stg_OWASP_Dependency_Check.yaml",
    {
...
resource "harness_platform_template" "stg_Semgrep_Sast_v1" {
  depends_on   = [time_sleep.step_groups_v2]
  ...
  force_delete = true
  template_yaml = templatefile(
    "${path.module}/templates/step_groups/v1/stg_Semgrep_Sast.yaml",
    {
